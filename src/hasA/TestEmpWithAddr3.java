...
public class TestEmpWithAddr3 {
	...
	private static void showEmp(Employee empObj) {
		empObj.show();
		if (empObj.getAddresses() != null && !empObj.getAddresses().isEmpty()) {
			int c =1;
			for (Address a : empObj.getAddresses()) {
